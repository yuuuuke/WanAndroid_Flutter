...
ArticleEntityListData _$ArticleEntityListDataFromJson(
        Map<String, dynamic> json) =>
    ArticleEntityListData(
...
Map<String, dynamic> _$ArticleEntityListDataToJson(
        ArticleEntityListData instance) =>
    <String, dynamic>{
